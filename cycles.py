...
#
# 8. Given a natural number N. Print the word YES if the number N is an exact power of two, or
# catch NO otherwise. It is not possible to use the exponentiation operation!
...
#
# 9. On the first day, the athlete ran X kilometers, and then he increased the mileage by 10%
...
# Вхідні дані:
#
# 10. The sequence consists of integers and ends with the number 0. Determine the value
